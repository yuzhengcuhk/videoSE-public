...
static const char* Sophos_method_names[] = {
  ...
  "/sse.sophos.Sophos/insert",
  "/sse.sophos.Sophos/bulk_insert",
};
...
Sophos::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_insert_(Sophos_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_bulk_insert_(Sophos_method_names[3], ::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
  {}
...
::grpc::Status Sophos::Stub::insert(::grpc::ClientContext* context, const ::sse::sophos::UpdateRequestMessage& request, ::google::protobuf::Empty* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_insert_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* Sophos::Stub::AsyncinsertRaw(::grpc::ClientContext* context, const ::sse::sophos::UpdateRequestMessage& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::google::protobuf::Empty>* Sophos::Stub::PrepareAsyncinsertRaw(::grpc::ClientContext* context, const ::sse::sophos::UpdateRequestMessage& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientWriter< ::sse::sophos::UpdateRequestMessage>* Sophos::Stub::bulk_insertRaw(::grpc::ClientContext* context, ::google::protobuf::Empty* response) {
  return ::grpc::internal::ClientWriterFactory< ::sse::sophos::UpdateRequestMessage>::Create(channel_.get(), rpcmethod_bulk_insert_, context, response);
}

::grpc::ClientAsyncWriter< ::sse::sophos::UpdateRequestMessage>* Sophos::Stub::Asyncbulk_insertRaw(::grpc::ClientContext* context, ::google::protobuf::Empty* response, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncWriterFactory< ::sse::sophos::UpdateRequestMessage>::Create(channel_.get(), cq, rpcmethod_bulk_insert_, context, response, true, tag);
}

::grpc::ClientAsyncWriter< ::sse::sophos::UpdateRequestMessage>* Sophos::Stub::PrepareAsyncbulk_insertRaw(::grpc::ClientContext* context, ::google::protobuf::Empty* response, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncWriterFactory< ::sse::sophos::UpdateRequestMessage>::Create(channel_.get(), cq, rpcmethod_bulk_insert_, context, response, false, nullptr);
}
...
Sophos::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< Sophos::Service, ::sse::sophos::UpdateRequestMessage, ::google::protobuf::Empty>(
          std::mem_fn(&Sophos::Service::insert), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ClientStreamingHandler< Sophos::Service, ::sse::sophos::UpdateRequestMessage, ::google::protobuf::Empty>(
          std::mem_fn(&Sophos::Service::bulk_insert), this)));
}
...
::grpc::Status Sophos::Service::insert(::grpc::ServerContext* context, const ::sse::sophos::UpdateRequestMessage* request, ::google::protobuf::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Sophos::Service::bulk_insert(::grpc::ServerContext* context, ::grpc::ServerReader< ::sse::sophos::UpdateRequestMessage>* reader, ::google::protobuf::Empty* response) {
  (void) context;
  (void) reader;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
